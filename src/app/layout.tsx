    ...
    <html lang="en" className={plusJakartaSans.variable}>
      <body>
        ...
        <script
          type="module"
          async
          src="https://static.rocket.new/rocket-web.js?_cfg=https%3A%2F%2Fgorillasal4684back.builtwithrocket.new&_be=https%3A%2F%2Fappanalytics.rocket.new&_v=0.1.20"
        />
