    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans selection:bg-yellow-500 selection:text-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <span className="hidden sm:inline-block ml-2 text-[10px] font-bold uppercase tracking-widest text-slate-900 bg-yellow-400 px-2 py-0.5 rounded border border-yellow-500/30">
                Enterprise CRM
              </span>
            </div>
          </Link>
      ...
      <section className="relative pt-12 pb-16 md:pt-20 md:pb-28 overflow-hidden bg-slate-50/60 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-yellow-100 border border-yellow-300 text-slate-900 text-xs font-bold mb-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/login"
              className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-yellow-500 hover:bg-yellow-400 text-slate-950 font-bold text-sm flex items-center justify-center gap-2 transition-colors shadow-md"
            >
              <Lock size={16} />
              <span>Get Started</span>
            </Link>
            <a
              href="#features"
              className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-sm border border-slate-200 flex items-center justify-center gap-2 transition-colors shadow-sm"
            >
          ...
          <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="p-4 rounded-xl bg-white border border-slate-200 text-left shadow-sm">
      ...
      <section id="heritage" className="py-16 md:py-24 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-yellow-50 border border-yellow-200 text-xs font-bold text-slate-900 mb-4">
            ...
            <div className="grid grid-cols-2 gap-4" id="products">
              <div className="p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2 shadow-sm">
                <div className="w-10 h-10 rounded-lg bg-yellow-400 border border-yellow-500/40 flex items-center justify-center text-slate-950 font-extrabold text-xs">
                  250G
                </div>
                ...
                <span className="inline-block text-[10px] bg-slate-200 text-slate-800 px-2 py-0.5 rounded font-bold">SKU: COF-250G</span>
              </div>
              ...
              <div className="p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2 shadow-sm">
                ...
                <span className="inline-block text-[10px] bg-slate-200 text-slate-800 px-2 py-0.5 rounded font-bold">SKU: COF-500G-MG</span>
              </div>
              ...
              <div className="p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2 shadow-sm">
                ...
                <span className="inline-block text-[10px] bg-slate-200 text-slate-800 px-2 py-0.5 rounded font-bold">SKU: COF-1KG-BEAN</span>
              </div>
              ...
              <div className="p-5 rounded-xl bg-slate-50 border border-slate-200 space-y-2 shadow-sm">
                ...
                <span className="inline-block text-[10px] bg-slate-200 text-slate-800 px-2 py-0.5 rounded font-bold">Commercial Pods</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl bg-white border border-slate-200 space-y-3 shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-yellow-100 border border-yellow-300 flex items-center justify-center text-slate-900">
            ...
            <div className="p-6 rounded-xl bg-white border border-slate-200 space-y-3 shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-yellow-100 border border-yellow-300 flex items-center justify-center text-slate-900">
                <BarChart3 size={20} className="text-yellow-700" />
              </div>
            ...
            <div className="p-6 rounded-xl bg-white border border-slate-200 space-y-3 shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-yellow-100 border border-yellow-300 flex items-center justify-center text-slate-900">
                <Layers size={20} className="text-yellow-700" />
              </div>
